...
CREATE TABLE GPT_COLLECTION (
    ...
    SHORTNAME  character varying(128) UNIQUE NOT NULL,
    CONSTRAINT GPT_COLLECTIONS_PK PRIMARY KEY (COLUUID)
) WITHOUT OIDS;
CREATE INDEX GPT_COLLECTION_IDX1 ON GPT_COLLECTION USING btree(SHORTNAME);
