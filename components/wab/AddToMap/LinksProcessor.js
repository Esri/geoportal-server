define([
  ...
  findContentTypeUrl: function(links){
      ...
      switch(theLinkType) {
        case "www":
            imgURL = "images/ContentType_clearinghouse.png";
            break;
        case "webmap":
            imgURL = "widgets/AddToMap/images/ContentType_liveData.png";
            break;
        case "mapserver":
            imgURL = "widgets/AddToMap/images/ContentType_liveData.png";
            break;
        ...
        case "wms":
            ...
            break;
        case "kml":
            imgURL = "widgets/AddToMap/images/ContentType_geographicActivities.png";
            break;
        default:
            imgURL = "widgets/AddToMap/images/ContentType_unknown.png";        
      }
