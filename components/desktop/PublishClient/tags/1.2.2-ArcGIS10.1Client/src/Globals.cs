    ...
    static class Globals
    {
        ...
        public static string ArcGISInstallationFolder
        {
            get
            {
                ...
                RegistryKey esriKey = Registry.LocalMachine.OpenSubKey("SOFTWARE\\ESRI\\Desktop10.0");
        ...
        public static string ArcGISDesktopMetadataConfig
        {
            get
            {
                ...
                RegistryKey esriKey = Registry.CurrentUser.OpenSubKey("Software\\ESRI\\Desktop10.0\\Metadata\\Config");
