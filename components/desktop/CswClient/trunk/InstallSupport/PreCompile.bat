...
RD /S /Q C:\Builds\GeoportalServer\10.4_CSWClients\Sources\CswClient\trunk
...
XCOPY C:\Repositories\geoportal-server\components\desktop\CswClient\trunk\*.* C:\Builds\GeoportalServer\10.4_CSWClients\Sources\CswClient\trunk /E /I /Y
