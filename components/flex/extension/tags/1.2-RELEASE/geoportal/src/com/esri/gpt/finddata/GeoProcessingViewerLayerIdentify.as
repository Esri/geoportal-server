...
package com.esri.gpt.finddata
{
    ...
    * */
   	public class GeoProcessingViewerLayerIdentify extends IdentifyTask
	{ 
		// instance variables  =================================================
		public var _layer:GeoProcessingViewerLayer = null;
		public var maxFeaturesIntersect:Number = 100;
		private const LOG:ILogger = Log.getLogger(
		  "GeoProcessingViewerLayerIdentify");
		  
		// constructor =========================================================
		/**
		 * constructor
		 * */
		public function GeoProcessingViewerLayerIdentify(
		  layer:GeoProcessingViewerLayer) 
		{
			_layer = layer;
		}
