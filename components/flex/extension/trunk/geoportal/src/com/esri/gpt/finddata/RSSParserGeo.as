...
package com.esri.gpt.finddata
{
  ...
  * */
  public class RSSParserGeo extends RSSParser {
    // class variables =========================================================
    ...
    * */
    public function RSSParserGeo(rss:XML, agsGptModel:RSSModel) {
    ...
    * */
    override protected function parse():SearchResultRecordList {
       ...
       var ac:SearchResultRecordList = new SearchResultRecordList(null,
    ...
    * */
    private function createRecord(xmlRecord:XML):SearchResultRecord {
      ...
      var record:SearchResultRecord = new SearchResultRecord();
      ...
      try {
        ...
        if(xmlList != null) {
          ...
          for each(item in xmlList) {
            arrLinks.addItem(new EndPoint(item.text(), item.@HREF,
              this.configXML, endPoint.linkParserId));
          }
          
        } else if (xml != null) {
          arrLinks.addItem(new EndPoint(xml.text(), xml.@HREF,
            this.configXML, endPoint.linkParserId));
        }
