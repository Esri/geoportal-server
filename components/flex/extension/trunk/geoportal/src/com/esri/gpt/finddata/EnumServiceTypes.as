...
public class EnumServiceTypes
{
  ...
  /** ArcGIS rest Map Server rest constant. Do not instantiate! */
  public static const AGS_REST_MAPSERVER:EnumServiceTypes = 
    new EnumServiceTypes("AGS_REST_MAPSERVER");
  
  /** ArcGIS rest Feature Server rest constant. Do not instantiate! */
  public static const AGS_REST_FEATURESERVER:EnumServiceTypes = 
    new EnumServiceTypes("AGS_REST_FEATURESERVER");
  
  /** ArcGIS rest Image Server rest constant. Do not instantiate! */
  public static const AGS_REST_IMAGESERVER:EnumServiceTypes = 
    new EnumServiceTypes("AGS_REST_IMAGESERVER");
  ...
  public static const AGS_WEBMAP:EnumServiceTypes = 
	  new EnumServiceTypes("AGS_WEBMAP");
