...
dojo.declare("gpt.identity.Users", null, {  
  ...
  init: function () {
	...
	elSearchUsrLbl.htmlFor = "user-searchText";
    ...
    var elGroupsLbl = document.createElement("span");
  ...
  parseUserInfo : function (elInfoTr,response){
	...
	for(var i in attributes){
		...
		var elAttrLabel = document.createElement("span");
	...
	for(var i in groups){
		...
		var elGroupLabel = document.createElement("span");
