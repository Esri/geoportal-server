 ...
 */
public class GeocodeServerHandler extends ServiceHandler {
  
  /** constructors ============================================================ */

  /** Default constructor. */
  public GeocodeServerHandler() {
    super();
  } 
  ...
  public void collectMetadata(ServiceHandlerFactory handlerFactory, ServiceInfo serviceInfo)
    ...
    serviceInfo.addKeywords("geographicService,service,locator,geocode,geocoder",",");
  }
