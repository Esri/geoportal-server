...
/**
 * Handles the collection of metadata for an ArcGIS network analysis service (NAServer).
 */
public class NAServerHandler extends ServiceHandler {
  
  /** constructors ============================================================ */

  /** Default constructor. */
  public NAServerHandler() {
    super();
  } 
