...
/**
 * Handles the collection of metadata for an ArcGIS mobile service (MobileServer).
 */
public class MobileServerHandler extends ServiceHandler {
  
  /** constructors ============================================================ */

  /** Default constructor. */
  public MobileServerHandler() {
    super();
  } 
