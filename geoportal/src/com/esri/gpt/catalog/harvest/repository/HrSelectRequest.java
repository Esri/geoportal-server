 ...
 * Uses search criteria to select repositories.
...
/**
 * Create instance of the request.
 * Uses repository uui to pick exactly one repository
 * @param requestContext request context
...
/**
 * Create instance of the request.
 * Uses localId to pick exactly one repository
 * @param requestContext request context
...
/**
 * Create instance of the request.
 * Creates list of all repositories
 * @param requestContext request context
 */
public HrSelectRequest(RequestContext requestContext) {
  super(requestContext, new HrCriteria(), new HrResult());
 ...
 */
private HrRecord readRecord(Connection con, ResultSet rs) throws SQLException {
