...
/**
 * Extended multi-field query parser.
 */
/**package*/class ExtMultiFieldQueryParser extends MultiFieldQueryParser {
   ...
   * @param fields array of field's names
   * @param a analyzer
   */
  public ExtMultiFieldQueryParser(String[] fields, Analyzer a, TermResolver streamer, QueryProvider queryProvider) {
    super(org.apache.lucene.util.Version.LUCENE_30,fields, a);
    ...
    this.resolver = streamer;
    this.queryProvider = queryProvider;
  }
  
  @Override
  public Query parse(String query) throws ParseException {
    return super.parse(resolver.resolve(query));
  }
