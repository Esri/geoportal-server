 ...
 */
public class EditorRequest extends PublicationRequest {
 ...
 */
public EditorRequest(RequestContext requestContext, 
                     Publisher publisher,
                     String sourceXml) {
  super(requestContext,publisher,sourceXml);
  String sMethod = MmdEnums.PublicationMethod.editor.toString();
