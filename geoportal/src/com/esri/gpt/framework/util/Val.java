...
// methods =====================================================================
     ...
     *
     * @param s the string to check
     * @return the checked string (trimmed, zero length if the supplied String
     * was null)
     */
     ...
     *
     * @param s the string to check
     * @param defaultVal the default value to return if the string is null or
     * empty
     * @return the checked string (trimmed, default value if the supplied String
     * was null or empty)
     */
    ...
    /**
     * Check a string value and ensures that it does not exceed a maximum
     * length.
     *
     * @param s the string to check
     ...
     * space for use in an HTTP header
     *
     * @param input
