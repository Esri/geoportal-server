...
// properties ==================================================================
  ...
  /**
   * Gets the modified date as date object. Uses the simple date format returned
   * by arcIMS CSW. If error, exception thrown. Use this.getModifiedDate to get
   * the String representation for self parsing i.e. yyyy-dd-MM HH:MM:SS e.g.
   * 2008-02-12 13:06:04
   *
  ...
  public Date getModifiedDateAsDateObject(String format) {
    ...
    try {
      return new IsoDateFormat().parseObject(date);
  ...
  /**
   * Checks if is default geometry. Tells us whether the record has a true
   * envelope or whether just the default geometry is being used.
   *
...
// methods =====================================================================
   ...
   * @param isExternal the is external (if the resource is not the native
   * search, set to true)
