...
/**
 * Resource protocol factory.
 */
public class ResourceProtocolFactory implements ProtocolFactoryExt {

  @Override
  public String getName() {
    return ProtocolType.RES.name();
  }

  @Override
  public Protocol newProtocol() {
    return new HarvestProtocolResource();
  }

  @Override
  public Protocol newProtocol(AppEnv hEnv) {
    return new HarvestProtocolResource(hEnv);
  }
}
