...
public class AsnUnestablishedUserException extends ApplicationException {

  /** Default constructor */
  public AsnUnestablishedUserException() {
    super("The current user was not established correctly.");
  }
