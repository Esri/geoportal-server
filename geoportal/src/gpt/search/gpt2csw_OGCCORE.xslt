...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <!-- #############################################################################################################
@author TM
@purpose Converts GPT Search Filter represntations to CSW search filters
################################################################################################################## -->
  <!--
Globals
-->
  ...
  <xsl:template match="/">
    <xsl:element name="csw:GetRecords" use-attribute-sets="GetRecordsAttributes" xmlns:csw="http://www.opengis.net/cat/csw/2.0.2" xmlns:ogc="http://www.opengis.net/ogc" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:gml="http://www.opengis.net/gml">
      <csw:Query typeNames="csw:Record">
        <xsl:choose>
          <xsl:when test="(normalize-space(//savedStates/@info) = 'doPrefetch') = 'true'">
...
************************************************************************************************************************************************************************************** -->
  <xsl:template name="filterSpatialBBox" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml">
    ...
    <gml:Box>
      <xsl:attribute name="srsName"><xsl:value-of select="$gmlBoxSrsName"/>
      </xsl:attribute>
...
******************************************************************************** -->
  <xsl:attribute-set name="GetRecordsAttributes">
    ...
    <xsl:attribute name="startPosition"><xsl:value-of select="//filter[@class='com.esri.gpt.catalog.search.SearchFilterPagination']/param[@name='startPosition']/@value"/></xsl:attribute>
    <xsl:attribute name="maxRecords"><xsl:choose><xsl:when test="(normalize-space(//savedStates/@info) = 'doPrefetch') = 'true'"><xsl:value-of select="$numOfPrefetchRecords"/></xsl:when><xsl:otherwise><xsl:value-of select="//filter[@class='com.esri.gpt.catalog.search.SearchFilterPagination']/param[@name='recordsPerPage']/@value"/></xsl:otherwise></xsl:choose></xsl:attribute>
