...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  xmlns:csw="http://www.opengis.net/cat/csw" xmlns:ows="http://www.opengis.net/ows" xmlns:dct="http://purl.org/dc/terms/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcmiBox="http://dublincore.org/documents/2000/07/11/dcmi-box/" exclude-result-prefixes="csw dc dct dcmiBox ows">
  ...
  <xsl:when test="/ows:ExceptionReport">
   ...
   <xsl:otherwise>
    <Records>
      <xsl:for-each select="/csw:GetRecordsResponse/csw:SearchResults/csw:SummaryRecord | //csw:Record">
        <Record>
          <ID>
