...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:ows="http://www.opengis.net/ows" xmlns:kml22="http://www.opengis.net/kml/2.2" xmlns:tml="http://www.opengis.net/tml" xmlns:sml="http://www.opengis.net/sensorML/1.0.1" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:gml="http://www.opengis.net/gml">
	...
	<xsl:template name="main">
      ...
      <rdf:Description>
        ...
        <xsl:choose>
  				<xsl:when test="//kml22:Document/kml22:name">
  					<dc:title>
  						<xsl:value-of select="//kml22:Document/kml22:name"/>
  					</dc:title>
          </xsl:when>
          <xsl:otherwise>
            <dc:title>               
              <xsl:call-template name="baseFilename">
				...
				<xsl:if test="//kml22:Document/kml22:description">
					<dc:description>
						<xsl:value-of select="//kml22:Document/kml22:description"/>
					</dc:description>
				</xsl:if>		
				<dc:format>
				...
				<xsl:for-each select="//kml22:key">
					<dc:subject>
						<xsl:value-of select="text()"/>
					</dc:subject>
				</xsl:for-each>
		   	    <xsl:for-each select="//kml22:name">
			    ...
			    <xsl:for-each select="//kml22:description">
					<xsl:if test="position() &lt; 500">
						<dc:subject>
							<xsl:value-of select="text()"/>
						</dc:subject>		
				...
				<!--<xsl:for-each select="//kml22:Link//kml22:href">
					<dct:references>
	...
	<xsl:template name="makeBBox">
		<xsl:variable name="polygon">
			<xsl:for-each select="//kml22:coordinates">
				<xsl:value-of select="."/>
				<xsl:value-of select="' '"/>
			</xsl:for-each>
		</xsl:variable>
