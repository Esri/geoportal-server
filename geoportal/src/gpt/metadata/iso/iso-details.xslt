...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gml="http://www.opengis.net/gml" 
	...
	<xsl:template name="Page_Title">
		<h1 class="toolbarTitle"><xsl:value-of select="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:title/gco:CharacterString | /gmd:MD_Metadata/gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:citation/gmd:CI_Citation/gmd:title/gco:CharacterString"/></h1>
		<hr/>
	</xsl:template>
	...
	<xsl:template name="Metadata_Info" >
		...
		<dl>
			<xsl:for-each select="/gmd:MD_Metadata/gmd:fileIdentifier">				
			<dt>
			...
			<dt>
				...
				<xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/gmd:MD_Metadata/gmd:language)" /></xsl:with-param>
				</xsl:call-template>: </em>
				<xsl:choose>
					<xsl:when test=" string-length(/gmd:MD_Metadata/gmd:language/gmd:LanguageCode/@codeListValue) > 0">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdCode.language.iso639_2.<xsl:value-of select="/gmd:MD_Metadata/gmd:language/gmd:LanguageCode/@codeListValue" /></xsl:with-param>
							</xsl:call-template>
					</xsl:when>
					<xsl:otherwise>
			...
			<dt>
				<em>						
				<xsl:call-template name="get_property">
				<xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/gmd:MD_Metadata/gmd:characterSet)" />: </xsl:with-param>
				</xsl:call-template>: </em>
				<xsl:value-of select="/gmd:MD_Metadata/gmd:characterSet"/>
			</dt>
			</xsl:if>
			<xsl:if test="/gmd:MD_Metadata/gmd:parentIdentifier">				
			<dt>
				<em>
				<xsl:call-template name="get_property">
				<xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/gmd:MD_Metadata/gmd:parentIdentifier)" /></xsl:with-param>
				</xsl:call-template>: </em>
				<xsl:value-of select="/gmd:MD_Metadata/gmd:parentIdentifier/gco:CharacterString"/>
			</dt>
			</xsl:if>
			<xsl:if test="/gmd:MD_Metadata/gmd:hierarchyLevel/gmd:MD_ScopeCode">			
			<dt>
				<em>
				<xsl:call-template name="get_property">
				...
				<xsl:call-template name="get_property">
				<xsl:with-param name="key">catalog.iso19139.<xsl:value-of select="local-name(/gmd:MD_Metadata/gmd:hierarchyLevel/gmd:MD_ScopeCode)" />.<xsl:value-of select="/gmd:MD_Metadata/gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue" />
				</xsl:with-param>
				</xsl:call-template>						
			</dt>
			</xsl:if>
			...
			<xsl:if test="/gmd:MD_Metadata/gmd:dateStamp">			
			<dt>
				<em>
				<xsl:call-template name="get_property">
				<xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/gmd:MD_Metadata/gmd:dateStamp)" /></xsl:with-param>
				</xsl:call-template>: </em>
				<xsl:value-of select="/gmd:MD_Metadata/gmd:dateStamp/gco:Date"/>
			</dt>
			</xsl:if>	
			<xsl:if test="/gmd:MD_Metadata/gmd:metadataStandardName">			
			<dt>
				<em>
				<xsl:call-template name="get_property">
				<xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/gmd:MD_Metadata/gmd:metadataStandardName)" /></xsl:with-param>
				</xsl:call-template>: </em>
				<xsl:value-of select="/gmd:MD_Metadata/gmd:metadataStandardName/gco:CharacterString"/>
			</dt>
			</xsl:if>	
			<xsl:if test="/gmd:MD_Metadata/gmd:metadataStandardVersion">
			<dt>
				<em>
				<xsl:call-template name="get_property">
				<xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/gmd:MD_Metadata/gmd:metadataStandardVersion)" /></xsl:with-param>
				</xsl:call-template>: </em>
	...
	<xsl:template name="Data_Quality_Info" >
		...
		<dl>
			<xsl:if test="/gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:scope/gmd:DQ_Scope/gmd:level/gmd:MD_ScopeCode">
			<dt>
				<em>
				<xsl:call-template name="get_property">
				...
				<xsl:call-template name="get_property">
				<xsl:with-param name="key">catalog.iso19139.MD_ScopeCode.<xsl:value-of select="/gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:scope/gmd:DQ_Scope/gmd:level/gmd:MD_ScopeCode/@codeListValue"/></xsl:with-param>
				</xsl:call-template>						
			</dt>
			</xsl:if>
			...
			<xsl:for-each select="/gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage/gmd:statement">
				<dt>
					<em>
					<xsl:call-template name="get_property">
	...
	<xsl:template match="/gmd:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor">
		<dl>
	...
	<xsl:template match="gmd:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat">
		<dl>
