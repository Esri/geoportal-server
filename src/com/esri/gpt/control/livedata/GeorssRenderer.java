 ...
 * Georss renderer.
 */
/*packge*/ abstract class GeorssRenderer extends MapBasedRenderer  {
  ...
  protected String newLayerDeclaration() {
    return "new esri.layers.GeorssLayer(\"" +getUrl()+ "\",\"" +getProxyUrl()+ "\",widget.getGeometryServiceUrl())";
  }
  ...
  public String toString() {
    return GeorssRenderer.class.getSimpleName() + "("+getUrl()+")";
  }
