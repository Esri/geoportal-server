 ...
 */
/*packge*/ abstract class SosRenderer extends MapBasedRenderer {

  protected abstract String getContextUrl();
  ...
  protected String newLayerDeclaration() {
    return "new esri.layers.SOSLayer(\"" +getContextUrl()+ "\",\"" +getUrl()+ "\",\"" +getProxyUrl()+ "\",widget.getGeometryServiceUrl())";
  }
  ...
  public String toString() {
    return SosRenderer.class.getSimpleName() + "("+getUrl()+")";
  }
